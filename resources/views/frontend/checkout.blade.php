                    ...
                    <div class="flex flex-col gap-5 mb-[30px]">
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <input type="text" name="name" placeholder="Write your complete name"
                                class="px-5 py-[13px] placeholder:text-smoke-purple placeholder:font-normal font-semibold text-base rounded-xl bg-primary border-2 border-transparent border-solid focus:border-persian-pink focus:outline-none"
                        ...
                        @foreach ($tickets as $ticket)
                            ...
                            <div class="inline-flex items-center justify-between gap-4">
                                <p class="text-base font-medium">
                                    {{ $ticket->name }} <span>{{ $ticket->quantity }}X</span>
                                </p>
